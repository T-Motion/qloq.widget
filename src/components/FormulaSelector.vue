<template>
  ...
  <div class="q-pa-md row items-start q-gutter-md">
    <q-card flat bordered class="my-card" :class="{selected: 'spoed' === formula}" @click="() => onCardSelect('spoed')">
      <q-card-section>
    ...
    <q-card flat bordered class="my-card" :class="{selected: '2wd' === formula}" @click="() => onCardSelect('2wd')">
      <q-card-section>
    ...
    <q-card flat bordered class="my-card" :class="{selected: '7wd' === formula}" @click="() => onCardSelect('7wd')">
      <q-card-section>
    ...
    <q-card flat bordered class="my-card" :class="{selected: '10wd' === formula}" @click="() => onCardSelect('10wd')">
      <q-card-section>
